package com.example.liaotian.context;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.example.liaotian.HelloApplication;
...
public class BigModelNew extends WebSocketListener {
    ...
    public static void setAppid(String appid) {
        BigModelNew.appid = appid;
    }

    public static void setApiSecret(String apiSecret) {
        BigModelNew.apiSecret = apiSecret;
    }

    public static void setApiKey(String apiKey) {
        BigModelNew.apiKey = apiKey;
    }
    ...
    public static volatile boolean  isAnswering=true;
    ...
    // 主函数
    public static void play(String text) throws Exception {
